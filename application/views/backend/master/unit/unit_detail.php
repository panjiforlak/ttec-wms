...
<i class = 'bi bi-backspace-fill'></i> Back
        ...
        <div class='card-body'>
            ...
            <form method='POST' action="<?php echo site_url('master/menu_form_add/add'); ?>">
                ...
                <div class='row mb-3'>
                    <label for='inputEmail' class='col-sm-2 col-form-label'>Unit Name</label>
                    <div class='col-sm-5'>
                        <input type='text' class='form-control form-control-sm text-capitalize' name='unit_name'
                            value="<?php echo $get_unit['unit_name']; ?>" readonly>
                    </div>
                </div>
